...
class Project(models.Model):
    ...
    owner = models.ForeignKey(User, related_name="owned_projects", on_delete=models.CASCADE, default=1)  # Владелец проекта
...
class CustomUser(AbstractUser):
    ...
    role = models.CharField(
        ...
        default='Employee',  # Укажите значение по умолчанию, если нужно
    )
